        ...
        <table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="/dashboard/posts/{{ $post->slug }}" class="badge text-bg-primary"><i class="bi bi-eye-fill"></i></a>
                <a href="/dashboard/posts/{{ $post->slug }}/edit" class="badge text-bg-warning"><i class="bi bi-pencil-square"></i></a>
